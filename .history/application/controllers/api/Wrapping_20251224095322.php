...
class Wrapping extends CI_Controller {
     ...
     * buat FMR inside atau outside sudah ada programnya, dari programbuat FMR Inside dan Outsidenya itu nanti dari FMR? kirim data terkait status in atau outnya? 
     */
