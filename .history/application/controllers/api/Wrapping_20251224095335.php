...
class Wrapping extends CI_Controller {
     ...
     * buat FMR inside atau outside sudah ada programnya, dari program itu nyimpan status in buat FMR Inside dan Outsidenya itu nanti dari FMR? kirim data terkait status in atau outnya? 
     */
