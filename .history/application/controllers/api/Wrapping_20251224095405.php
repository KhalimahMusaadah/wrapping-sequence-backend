...
class Wrapping extends CI_Controller {
     ...
     * buat FMR inside atau outside sudah ada programnya, dari program itu nyimpan status in atau out, lalu dari backend ambil data nya buat FMR Inside dan Outsidenya itu nanti dari FMR? kirim data terkait status in atau outnya? 
     */
