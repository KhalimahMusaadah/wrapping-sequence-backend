...
class Wrapping extends CI_Controller {
    ...
    public function ready()
    {
        ...
        //start untuk polling
        $pollingResult = $this->pollingInsideFmrOnly();
    ...
    private function pollingInsideFmrOnly()
    {
        $mapId = 6;
        $timeoutSeconds = 60;
        $interval = 3;
        ...
        log_message('info', '[POLLING] START polling FMR wrapping zone (inside only)');
