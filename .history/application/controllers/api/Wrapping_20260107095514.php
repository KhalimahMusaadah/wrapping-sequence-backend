...
class Wrapping extends CI_Controller {
    ...
    private function triggerWrap($macAddress)
    {
        ...
        // Simulasi trigger wrap ke IoT device
        // Di sini bisa ditambahkan kode untuk mengirim perintah ke device sebenarnya

        log_message('info', "[WRAP TRIGGER] WRAP command sent to mac_address={$macAddress}");
    }
