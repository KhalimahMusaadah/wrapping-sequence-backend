...
class Wrapping extends CI_Controller {
    ...
    private function triggerWrap($macAddress)
    {
        ...
        // ===========================
        $iotUrl = "http://10.8.15.230:8080/api/wrapping/command"; // ganti sesuai IP & port IoT
        $payload = [
        ...
        if ($response === false) {
            ...
            // Tetap simpan log DB walau gagal trigger IoT
            $this->Wrapping_model->insertIoTLog([
                'mac_address' => $macAddress,
                'status'      => 'WRAP_FAILED',
                'call_status' => 'ERROR',
        ...
        // Decode response dari IoT (jika ada)
