...
class Wrapping extends CI_Controller {
    ...
    private function callAmrApi($mapId)
    {
        ...
        $cookie = 'JSESSIONID=abeca655-cdff-42e4-86e7-f3e4f26aa772; userName=Developt';
    ...
    public function done()
    {
        ...
        $this->Wrapping_model->insertTriggerHist([
            'deviceId' => $mac_address,
            'taskId'   => $rcsResult['task_id'] ?? 0,
            'sequence' => $rcsResult['sequence'] ?? 0,
            'flag'     => $rcsResult['success'] ? 1 : 0
        ]);
