...
class Lanxin_wrapper {
    ...
    public function triggerRCS($deviceId, $port, $sequence = null)
    {
        ...
        return $this->executeTrigger($deviceId, $taskId, $ipServer);
    }
    ...
    private function triggerRCSWithSequence($deviceId, $port, $sequence)
    {
        ...
        $result = $this->executeTrigger($deviceId, $taskId, $ipServer);
    ...
    private function executeTrigger($deviceId, $taskId, $ipServer)
    {
        ...
        $flag = $success ? 1 : 0;
        $this->task->ExecQuery(
            "INSERT INTO trigger_hist(deviceId, taskId, flag, created_at) 
             VALUES('$deviceId', '$taskId', '$flag', NOW())"
        );
